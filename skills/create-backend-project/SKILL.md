...
description: >
  ...
  (the company backend canon) with zod request validation, usecase classes, repository
  ...
  Socket.IO. Runs via the bundled node CLI or by the AI applying the same
